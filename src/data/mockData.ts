...
// ─── REAL IPL 2026 Completed Matches (Matches 1–48) ────────────────────────────
// Sources: ESPNcricinfo, IPLT20.com, myKhel.com
// NOTE: The real IPL 2026 schedule is different from the previous mock fixture list.
export const completedMatches: Match[] = [
  // Match 1–10 (Mar 28 – Apr 4)
  { id: 1, matchNumber: 1, team1: 'RCB', team2: 'SRH', winner: 'RCB', margin: 7, marginType: 'wickets', date: '2026-03-28', venue: 'M. Chinnaswamy Stadium, Bengaluru', status: 'completed' },
  { id: 2, matchNumber: 2, team1: 'KKR', team2: 'MI', winner: 'KKR', margin: 7, marginType: 'wickets', date: '2026-03-29', venue: 'Eden Gardens, Kolkata', status: 'completed' },
  { id: 3, matchNumber: 3, team1: 'CSK', team2: 'RR', winner: 'RR', margin: 6, marginType: 'wickets', date: '2026-03-30', venue: 'MA Chidambaram Stadium, Chennai', status: 'completed' },
  { id: 4, matchNumber: 4, team1: 'GT', team2: 'PBKS', winner: 'PBKS', margin: 6, marginType: 'wickets', date: '2026-03-31', venue: 'Narendra Modi Stadium, Ahmedabad', status: 'completed' },
  { id: 5, matchNumber: 5, team1: 'LSG', team2: 'DC', winner: 'LSG', margin: 1, marginType: 'wickets', date: '2026-04-01', venue: 'Ekana Stadium, Lucknow', status: 'completed' },
  { id: 6, matchNumber: 6, team1: 'SRH', team2: 'KKR', winner: 'SRH', margin: 33, marginType: 'runs', date: '2026-04-02', venue: 'Rajiv Gandhi Stadium, Hyderabad', status: 'completed' },
  { id: 7, matchNumber: 7, team1: 'CSK', team2: 'PBKS', winner: 'PBKS', margin: 7, marginType: 'wickets', date: '2026-04-03', venue: 'MA Chidambaram Stadium, Chennai', status: 'completed' },
  { id: 8, matchNumber: 8, team1: 'MI', team2: 'DC', winner: 'DC', margin: 7, marginType: 'wickets', date: '2026-04-04', venue: 'Wankhede Stadium, Mumbai', status: 'completed' },
  { id: 9, matchNumber: 9, team1: 'RR', team2: 'GT', winner: 'RR', margin: 3, marginType: 'wickets', date: '2026-04-05', venue: 'Sawai Mansingh Stadium, Jaipur', status: 'completed' },
  { id: 10, matchNumber: 10, team1: 'SRH', team2: 'LSG', winner: 'LSG', margin: 1, marginType: 'wickets', date: '2026-04-06', venue: 'Rajiv Gandhi Stadium, Hyderabad', status: 'completed' },

  // Match 11–20 (Apr 6 – Apr 14)
  { id: 11, matchNumber: 11, team1: 'RCB', team2: 'CSK', winner: 'RCB', margin: 5, marginType: 'wickets', date: '2026-04-07', venue: 'M. Chinnaswamy Stadium, Bengaluru', status: 'completed' },
  { id: 12, matchNumber: 12, team1: 'KKR', team2: 'PBKS', winner: 'PBKS', margin: 10, marginType: 'runs', date: '2026-04-08', venue: 'Eden Gardens, Kolkata', status: 'completed' },
  { id: 13, matchNumber: 13, team1: 'RR', team2: 'MI', winner: 'RR', margin: 4, marginType: 'wickets', date: '2026-04-09', venue: 'Sawai Mansingh Stadium, Jaipur', status: 'completed' },
  { id: 14, matchNumber: 14, team1: 'GT', team2: 'DC', winner: 'GT', margin: 11, marginType: 'runs', date: '2026-04-10', venue: 'Narendra Modi Stadium, Ahmedabad', status: 'completed' },
  { id: 15, matchNumber: 15, team1: 'KKR', team2: 'LSG', winner: 'KKR', margin: 4, marginType: 'wickets', date: '2026-04-11', venue: 'Eden Gardens, Kolkata', status: 'completed' },
  // Note: KKR beat LSG via Super Over (tied at 155/7 & 155/8, then KKR 4/0 vs LSG 1/2)
  { id: 16, matchNumber: 16, team1: 'RCB', team2: 'RR', winner: 'RCB', margin: 9, marginType: 'wickets', date: '2026-04-12', venue: 'M. Chinnaswamy Stadium, Bengaluru', status: 'completed' },
  { id: 17, matchNumber: 17, team1: 'SRH', team2: 'PBKS', winner: 'PBKS', margin: 16, marginType: 'runs', date: '2026-04-13', venue: 'Rajiv Gandhi Stadium, Hyderabad', status: 'completed' },
  { id: 18, matchNumber: 18, team1: 'CSK', team2: 'DC', winner: 'CSK', margin: 8, marginType: 'wickets', date: '2026-04-14', venue: 'MA Chidambaram Stadium, Chennai', status: 'completed' },
  { id: 19, matchNumber: 19, team1: 'LSG', team2: 'GT', winner: 'GT', margin: 6, marginType: 'wickets', date: '2026-04-15', venue: 'Ekana Stadium, Lucknow', status: 'completed' },
  { id: 20, matchNumber: 20, team1: 'RCB', team2: 'MI', winner: 'RCB', margin: 32, marginType: 'runs', date: '2026-04-16', venue: 'M. Chinnaswamy Stadium, Bengaluru', status: 'completed' },

  // Match 21–30 (Apr 17 – Apr 20)
  { id: 21, matchNumber: 21, team1: 'SRH', team2: 'RR', winner: 'SRH', margin: 47, marginType: 'runs', date: '2026-04-17', venue: 'Rajiv Gandhi Stadium, Hyderabad', status: 'completed' },
  { id: 22, matchNumber: 22, team1: 'CSK', team2: 'KKR', winner: 'CSK', margin: 4, marginType: 'wickets', date: '2026-04-18', venue: 'MA Chidambaram Stadium, Chennai', status: 'completed' },
  { id: 23, matchNumber: 23, team1: 'LSG', team2: 'RCB', winner: 'LSG', margin: 1, marginType: 'wickets', date: '2026-04-18', venue: 'Ekana Stadium, Lucknow', status: 'completed' },
  { id: 24, matchNumber: 24, team1: 'MI', team2: 'PBKS', winner: 'PBKS', margin: 27, marginType: 'runs', date: '2026-04-19', venue: 'Wankhede Stadium, Mumbai', status: 'completed' },
  ...
  { id: 26, matchNumber: 26, team1: 'RCB', team2: 'DC', winner: 'RCB', margin: 26, marginType: 'runs', date: '2026-04-18', venue: 'M. Chinnaswamy Stadium, Bengaluru', status: 'completed' },
  { id: 27, matchNumber: 27, team1: 'SRH', team2: 'CSK', winner: 'SRH', margin: 3, marginType: 'wickets', date: '2026-04-18', venue: 'Rajiv Gandhi Stadium, Hyderabad', status: 'completed' },
  ...
  // Match 38: Tied — KKR won Super Over (KKR 4/0 vs LSG 1/2)
  { id: 38, matchNumber: 38, team1: 'LSG', team2: 'KKR', winner: 'KKR', margin: 0, marginType: 'runs', date: '2026-04-26', venue: 'Ekana Stadium, Lucknow', status: 'completed' },
...
export const probabilityHistory: ProbabilityEntry[] = [
  ...
  { matchNumber: 40, probabilities: { PBKS: 90, RCB: 86, SRH: 80, RR: 78, GT: 74, CSK: 46, DC: 24, KKR: 20, MI: 12, LSG: 6 } },
  { matchNumber: 48, probabilities: { PBKS: 92, RCB: 88, SRH: 82, RR: 79, GT: 72, CSK: 48, DC: 22, KKR: 18, MI: 10, LSG: 4 } },
];